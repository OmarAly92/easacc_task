...
import 'package:easacc_task/core/app_themes/text_style/font_weight_helper.dart';

sealed class AppTextStyle {
  /// Style Generator
  static TextStyle _textStyle(double size, FontWeight weight) {
    return TextStyle(fontSize: size.spMin, color: AppColors.black, fontWeight: weight);
  }
  ...
  static TextStyle get style18Bold => _textStyle(18, FontWeightHelper.bold);
