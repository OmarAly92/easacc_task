...
import 'package:easacc_task/core/helpers/localization/app_localization.dart';
import 'package:easacc_task/core/utils/app_methods.dart';
...
extension GetWeekNumber on DateTime {
  int get weekNumber {
    return AppMethods.getCurrentWeekOfMonth(this);
  }
}
...
extension IntFlagToBool on int {
  bool toBool() => this == 1;
}
